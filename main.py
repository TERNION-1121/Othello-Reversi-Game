...
blackDiscCounter = pygame.image.load("images/Large_Black_Disc.png")
whiteDiscCounter = pygame.image.load("images/Large_White_Disc.png")
...
endScreenDraw = pygame.image.load("images/End_Screen_Draw.png")
endPrompt  = pygame.image.load("images/End_Prompt.png")

discCountFont = pygame.font.Font("Gotham-Font/GothamLight.ttf", 40)
